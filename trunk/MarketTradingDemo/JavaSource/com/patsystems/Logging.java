...
/**
 * <h1>Logging</h1>
 * <p>Logging handles the recording of all the method calls and errors within the Java Demo App. The log file
 * is located in the "API Demo Data Files" folder. </p>
...
public class Logging
{
     ...
     */
    public Logging(String location) throws FileNotFoundException
    {
        errorFile = new FileOutputStream(location + "JavaDemoError.log");
    }

    /**
     * adds the <code>String</code> to the log file
     *
     * @param msg String
     */
    public void addMessage(String msg)
    {
        ...
        {
            JOptionPane.showMessageDialog(null, "Error writing to error file");
        }
