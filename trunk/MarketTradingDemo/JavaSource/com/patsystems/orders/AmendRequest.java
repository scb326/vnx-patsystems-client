...
/**
 * <h1>AmendRequest</h1>
 * <p>Populates a byte buffer with the amend order information to be sent to the JavaWrapper </p>
...
public class AmendRequest
{
     ...
     * @param lots
     */
    public AmendRequest(String account, String orderId, String exchange, String commodity, String contract, String price, int lots)
    {
        orderID = orderId;
        buffer = new byte[StructDefinitions.SIZE_AMEND_ORDER_STRUCT];
        ...
        stasher.append(lots);
        stasher.append(orderId, StructDefinitions.SIZE_ORDER_ID);
        stasher.skip(1);
