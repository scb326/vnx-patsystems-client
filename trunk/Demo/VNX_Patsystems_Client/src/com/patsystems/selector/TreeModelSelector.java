...
/**
 * <h1>TreeModelSelector</h1>
 * <p>The model for the treeview which will display all of the exchanges, commodities and contracts</p>
...
public class TreeModelSelector extends DefaultTreeModel {
     ...
     * @param clientAPI
     */
    public TreeModelSelector (ClientAPI clientAPI)
    {
        super(new SessionNode(clientAPI));
