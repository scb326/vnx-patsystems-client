...
/**
 * <h1>StructConverter</h1>
 * <p>This converts the structure from any buffer location to a string representation of it</p>
 * <P>Declared <code>final</code> so it cannot be over ridden</P
...
public final class StructConverter
{
    ...
    /**
     * <p> converts the structure from any buffer location to a string representation of it</p>
     * @param buffer
     * @param start
     * @param count
     * @return a string rep of the buffer from <code>start</code> for <code>count</code> places
     */
